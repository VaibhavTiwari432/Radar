...
%   velOptionsMps clamped.
    ...
    methods (TestClassSetup)
        function assumeArchivedDependencyPresent(tc)
            ...
            % agent.buildEnvDoppler, which no longer exists. Report Incomplete --
            ...
            tc.assumeTrue(archivedDepsPresent({'agent.buildEnvDoppler'}), ...
                'agent.buildEnvDoppler was archived 7 Aug 2026 (GOVERNANCE.md). This test is PENDING REWIRE to generator.render, not passing -- see trash/BROKEN_DOWNSTREAM.md.');
        end
    end
