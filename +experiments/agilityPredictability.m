...
%   renders and predicts; it never decides whether it succeeded.
    ...
    K = struct('PW_S',12e-6,'BW_HZ',2e6,'PRF_HZ',physics.Constants().PRF,'CARRIER',10e9, ...
...
%   template chosen by PREDICTION instead of by a fixed fresh/stale rule.
    ...
    sg = engine.entity.EntityState('range_m', K.GEN_R0, 'range_rate_mps', -40, ...
            'class', 'fighter', 'rcs_dbsm', 0, 'swerling', 0);
    sp = engine.entity.EntityState('range_m', K.PH_R0, 'range_rate_mps', -40, ...
            'class', 'fighter', 'rcs_dbsm', 0, 'swerling', 0);
