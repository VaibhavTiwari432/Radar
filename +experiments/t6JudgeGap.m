...
%   waveform constants so the two judges see the same radar.
    ...
    S = struct('rx_frames', cubeFrames, 'fs', C.fs, ...
        'pulse_width_s', 12e-6, 'bandwidth_hz', 2e6, 'prf_hz', 50e3, ...
        'cfar_pfa', 1e-4, 'cfar_num_training', 20, 'cfar_num_guard', 4, ...
        'frame_interval_s', spec.dt, 'carrier_hz', spec.carrierHz, ...
        'assignment_gate_m', 200, 'confirmation_threshold', [3 5], ...
        'deletion_threshold', [5 5], 'filter_model', 'cv', ...
        'tracker_type', 'gnn', 'eccm_screens', {{'amplitude','doppler'}});
